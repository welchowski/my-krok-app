...
export default function FlashCard() {
  ...
  // Твій масив питань (можна залишити як є)
  const questionsMOKUP = [
    ...
    // ... інші 3 питання (скопіюй їх сюди)
  ];

  // Перетворюємо масив у потрібний формат для FlashCard
  const cards: FlashCard[] = questionsMOKUP.map((item, idx) => ({
    id: idx + 1,
  ...
  if (cards.length === 0) {
    return <div className="min-h-screen grid place-items-center">Карток немає</div>;
  }
